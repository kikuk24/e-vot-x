...
class Aisyiyah extends CI_Controller
{
	...
	{
		$this->data['config'] = $this->Config_model->getConfig('2');
		$this->load->view('v_welcome_aisyiyah', $this->data);
	}
	...
	public function check()
	{
		...
		if (!isset($kode)) {
			...
			if ($pemilih->ID_JENIS_VOTE == '2' && $pemilih->STATUS == '0' && $sisa_pilihan != 0 && $tgl_vote == date('Y-m-d')) {
				$data_session = array(
