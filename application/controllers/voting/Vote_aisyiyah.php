...
class Vote_aisyiyah extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->data['calon'] = $this->Calon_model->getCalon($this->session->userdata('id_pemilih'), '2'); //AISYIYAH
		...
		$this->data['halaman'] = 'aisyiyah/v_pilihan';
		$this->load->view('aisyiyah/v_halaman', $this->data);
	}
	...
	public function pilih($id_calon)
	{
		...
		if ($pilihan_ke <= $jml_max_pilihan && $cek_pilihan < 1) {
			...
			redirect(site_url('voting/vote_aisyiyah'));
		} else {
