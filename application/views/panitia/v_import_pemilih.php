...
<div class="container-fluid px-4">
    ...
    <a href="<?= base_url('file/temp_pemilih.xls') ?>">Download Template Excel</a>
    <div class="row">
        <div class="col-xl-6">
            <div class="card mb-4">
                <div class="card-header">
                    Form Import Data Pemilih
                </div>
                <div class="card-body">
                    <?php if ($this->session->flashdata('sukses')) : ?>
                        <h4><?= $this->session->flashdata('sukses') ?></h4>
                    <?php endif; ?>
                    <form action="<?= site_url('panitia/pemilih/import_save') ?>" method="post" enctype="multipart/form-data">
