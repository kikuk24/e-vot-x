...
<head>
	...
	<title>Musyawaraah Ikatan Pelajar Muhammadiyah</title>
				...
				<div class="col-lg-12">
					<div class="inner text-center">
						<div class="section-title text-center">
							...
							<h2 class="title color-white"><strong>Pimpinan Cabang Aisyiah</strong> Tegalrejo</h2>
							<p><?= $config->KETERANGAN ?></p>
						</div>
						<form action="<?= site_url('aisyiyah/check') ?>" method="post" class="newsletter-form-1 mt--40">
							<input type="text" name="kode" placeholder="Masukkan Kode Unik">
