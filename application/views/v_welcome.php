							...
							<div class="inner text-center">
								<div class="section-title">
									<a href="<?= site_url('panitia') ?>">
										<span class="subtitle bg-primary-opacity">E-Voting Online</span>
									</a>
								</div>

								<h1 class="banner-title">Musyawarah Ikatan Pelajar Muhammadiyah
									<!-- <span class="theme-gradient">& Aisyiyah</span> -->
								</h1>
								...
								<div class="slider-btn rbt-button-group justify-content-center">
									...
									<!-- <img src="<?= base_url() ?>assets/images/logo-aisyiyah.png" width="100" height="100" /><br> -->
								...
								<div class="slider-btn rbt-button-group justify-content-center">
									...
									<a class="rbt-btn btn-success rbt-switch-btn rbt-switch-y" href="<?= site_url('muhammadiyah') ?>">
										<span data-text="Pilih Sekarang">Silahkan Masuk</span>
									</a>

									<!-- <a class="rbt-btn btn-gradient rbt-switch-btn rbt-switch-y" href="<?= site_url('aisyiyah') ?>">
										<span data-text="Voting Aisyiyah">Aisyiyah</span>
									</a> -->
